          ...
          <div className="relative flex h-full w-full flex-col overflow-hidden md:flex-row md:rounded-[34px]">
            <div className="hidden md:flex md:w-[48%] md:flex-col md:justify-between md:overflow-hidden md:border-r md:border-[#1b1b22] md:bg-[radial-gradient(circle_at_25%_20%,rgba(99,102,241,0.2),transparent_25%),radial-gradient(circle_at_70%_30%,rgba(236,72,153,0.2),transparent_20%),linear-gradient(180deg,#13131a_0%,#0f0f15_55%,#09090b_100%)] md:p-8">
              <div className="flex items-center justify-between">
                ...
                <Drawer.Close className="flex size-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-[#f7f7f8] transition-colors hover:bg-white/10">
                  <X className="h-5 w-5" />
                </Drawer.Close>
              </div>
            ...
            <div className="flex h-full flex-col overflow-hidden md:w-[52%] md:bg-[#09090b]">
              <div className="flex items-center justify-between px-4 py-4 md:px-8 md:pt-8">
                ...
                <Drawer.Close className="flex size-10 items-center justify-center rounded-full border border-[#2a2a31] bg-[#111115] text-[#f7f7f8] transition-colors hover:bg-[#18181d]">
                  <X className="h-5 w-5" />
                </Drawer.Close>
              </div>
