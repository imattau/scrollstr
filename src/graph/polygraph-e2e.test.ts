...
describe('PolyGraph E2E — in-memory indexes', () => {
  ...
  it('indexes cleaned up on eviction', () => {
    // Add more than HOT_CACHE_MAX (75000) nodes to trigger eviction
    const COUNT = 75_050
    ...
    // HOT_CACHE_MAX is 75000, so ~50 nodes should have been evicted
    const totalNodes = (pg as any).nodes.size
    expect(totalNodes).toBeLessThanOrEqual(75000)
